...
{
    public class WindowsReadCharacteristicCommand : IDisposable
    {
        ...
        public WindowsReadCharacteristicCommand(string deviceAddress, string serviceUuid, string characteristicUuid)
        {
        ...
        {
            if (_disposed)
                throw new ObjectDisposedException(nameof(WindowsReadCharacteristicCommand));
            ...
            try
            {
                ...
                WindowsBleNativePlugin.ReadCharacteristic(_deviceAddress, _serviceUuid, _characteristicUuid);
